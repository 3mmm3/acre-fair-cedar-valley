        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              طلایی ۹۰+ · نقره‌ای ۸۵–۸۹ · برنزی ۸۱–۸۴ (حدنصاب مشترک) · امتیاز بسته به سطح · ۲ برتر طلا/نقره ↑ · ۲ ضعیف‌تر ↓
            </p>
          </CardHeader>
          <CardContent>
          ...
          <Card className="border-amber-500/40">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-amber-700">
                ...
                هشدار تعلیق — دو روز عملکرد ضعیف (نمره زیر ۷۰)
              </CardTitle>
              <p className="text-sm text-muted-foreground">
                یک روز تعلیق (عدم حضور و کار در منزل). اگر روز بعد هم ضعیف باشد، از دوره حذف می‌شود.
              </p>
            </CardHeader>
            <CardContent className="flex flex-wrap gap-2">
              {suspended.map((r) => (
                ...
                >
                  {r.student.fullName} ({r.c.lowDays} روز ضعیف)
                </Link>
              ))}
            </CardContent>
          </Card>
                      ...
                      <tr key={r.student.id} className="border-b border-border/70 last:border-0 hover:bg-muted/40">
                        ...
                        <td className="px-4 py-2.5">
                          <div className="flex flex-wrap items-center gap-1">
                            ...
                            {r.c.nextLevel === "C" || r.c.cleaningDuty ? (
                              <Badge variant="c">نظافت</Badge>
                            ) : null}
                            {r.c.suspended ? <Badge variant="c">تعلیق</Badge> : null}
                          </div>
                        </td>
                      </tr>
                    ))}
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-xs text-muted-foreground">
                  ۲ برتر هر سطح با کارت طلا/نقره ↑ · ۲ ضعیف‌تر سطح بالاتر ↓
                </p>
              </CardHeader>
              <CardContent className="space-y-3 text-sm">
                {promoted.length === 0 && demoted.length === 0 ? (
                  <p className="text-muted-foreground">در این هفته جابه‌جایی سطح ثبت نشده (پس از قفل هفته اعمال می‌شود).</p>
                ) : null}
                {promoted.map((r) => (
